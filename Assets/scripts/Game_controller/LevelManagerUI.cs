...
public class LevelManagerUI: MonoBehaviour{
    [Header("Game Datos")][SerializeField]
    int Life,  Score=0, Heart=10, coins ;
    
    int lifeGameOver=0;
    [Header("textos")][SerializeField]
     TextMeshProUGUI Points,Lives,HeartText;
     [Header("Dependencias")][SerializeField]
     LevelManagerText ManagerText;
